...
最后附上Swift黑语法，大家自行揣摩吧:

```c
//name mangling:
println(_stdlib_getTypeName(obj))
(_TtC16TestSwiftRuntime12MySwiftClass)

//demangling:
println(_stdlib_demangleName(_stdlib_getTypeName(obj)))
(TestSwiftRuntime.MySwiftClass)
